# Sistema de Busca TCC

Este projeto é um sistema de busca que utiliza técnicas de Processamento de Linguagem Natural e Inteligência Artificial para encontrar artigos relevantes.
